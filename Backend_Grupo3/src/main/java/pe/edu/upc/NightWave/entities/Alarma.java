...
public class Alarma {
    ...
    public Alarma(int idAlarma, String nombreAlarma, LocalDateTime horaAlarma, String diasSemana, boolean activa, Users idUsuario, MusicaMultimedia idMusicaMultimedia) {
