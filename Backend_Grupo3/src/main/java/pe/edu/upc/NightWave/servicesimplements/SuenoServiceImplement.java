...
public class SuenoServiceImplement implements ISuenoService
{
    ...
    @Override
    public List<Sueno> BuscarPorUmbralCalidadDeSueno(int calidadSueno) {
        return sR.findByCalidadSuenoLessThanEqualOrderByFechaRegistroDesc(calidadSueno);
    }

    @Override
    public List<Object[]> promedioSuenoTodosUsuarios() {
        return sR.promedioSuenoTodosUsuarios();
    }

    @Override
    public List<Object[]> horasDormidasPorUsuarioPorRegistro() {
        return sR.horasDormidasPorUsuarioPorRegistro();
    }
}
