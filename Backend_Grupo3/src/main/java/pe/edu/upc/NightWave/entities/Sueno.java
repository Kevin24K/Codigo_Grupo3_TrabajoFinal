...
public class Sueno {
    ...
    public Sueno(int idSueno, LocalDate fechaRegistro, LocalDateTime horaAcostarse, LocalDateTime horaDespertar, int calidadSueno, int interrupciones, boolean cafeinaConsumida, String notas, Users idUsuario) {
