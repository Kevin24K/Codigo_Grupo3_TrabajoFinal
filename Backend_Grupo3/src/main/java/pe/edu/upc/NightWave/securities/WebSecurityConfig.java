    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers("/roles/**").permitAll()
                        .requestMatchers("/suenos").permitAll()
                        .requestMatchers("/suenos/**").permitAll()
                        .requestMatchers("/actividades").permitAll()
                        .requestMatchers("/actividades/**").permitAll()
                        .requestMatchers("/alarmas").permitAll()
                        .requestMatchers("/alarmas/**").permitAll()
                        .requestMatchers("/estres").permitAll()
                        .requestMatchers("/estres/**").permitAll()
                        .requestMatchers("/evaluacionesdiarias").permitAll()
                        .requestMatchers("/evaluacionesdiarias/**").permitAll()
                        .requestMatchers("/notificaciones").permitAll()
                        .requestMatchers("/notificaciones/**").permitAll()
                        .requestMatchers("/objetivos").permitAll()
                        .requestMatchers("/objetivos/**").permitAll()
                        .requestMatchers("/objetivosrecompensas").permitAll()
                        .requestMatchers("/objetivosrecompensas/**").permitAll()
