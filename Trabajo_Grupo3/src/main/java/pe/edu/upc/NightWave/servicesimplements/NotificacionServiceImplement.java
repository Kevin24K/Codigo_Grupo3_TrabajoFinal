...
public class NotificacionServiceImplement implements INotificacionService
{
    ...
    public List<Notificacion> listarPorUsuario(Long idUsuario) {
        return nR.findByIdUsuarioId(idUsuario);
    }

    @Override
    public List<Notificacion> listarNoLeidasPorUsuario(Long idUsuario) {
        return nR.findByIdUsuarioIdAndLeidaFalse(idUsuario);
    }
